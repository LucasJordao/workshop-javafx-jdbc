...
public class SellerListController implements Initializable, DataChangeListener {
	...
	@FXML
	private TableColumn<String, Integer> tableColumnName;

	@FXML
	private TableColumn<String, Integer> tableColumnEmail;

	@FXML
	private TableColumn<String, Date> tableColumnBirthDate;

	@FXML
	private TableColumn<String, Double> tableColumnBaseSalary;
